...
class Time:
    ...
    @classmethod
    def frfom_milliseconds(cls, milliseconds: Numeric) -> Self:
...
class Timeline:
    ...
    def __rshift__(self, seconds: Numeric | Time) _ Self:
        self.instant += seconds
        return self
    
@dataclass
class MeausredTimeline(Timeline):
    measure: Time(seconds=0)
